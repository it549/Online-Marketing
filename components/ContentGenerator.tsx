              ...
              {PLATFORMS.map((p) => (
                <button
                  ...
                  className={`flex-1 py-2 rounded-lg text-sm font-medium transition-colors ${
                    platform === p ? "bg-blue-600 text-white" : "bg-slate-700 text-slate-400 hover:bg-slate-600"
                  }`}
                >
                  {p}
                </button>
              ...
              {TONES.map((t) => (
                <button
                  ...
                  className={`flex-1 py-2 rounded-lg text-xs font-medium transition-colors ${
                    tone === t ? "bg-purple-600 text-white" : "bg-slate-700 text-slate-400 hover:bg-slate-600"
                  }`}
                >
                  {t}
                </button>
