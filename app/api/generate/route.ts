...
${platform === "TikTok" || platform === "ทั้งคู่" ? `สร้าง TikTok Script:
- Hook (3 วินาทีแรก): ประโยคที่ดึงความสนใจ
- เนื้อหา: อธิบายงาน/บริการ 30-45 วินาที
- CTA: call to action ชัดเจน` : ""}

${platform === "Facebook" || platform === "ทั้งคู่" ? `สร้าง Facebook Post:
- Caption: 3-5 ประโยค
...
เขียนภาษาไทยที่เป็นธรรมชาติ น่าเชื่อถือ และกระตุ้นให้ติดต่อ`;
  ...
  try {
    ...
    return NextResponse.json({ error: e.message || "AI ไม่สามารถสร้าง content ได้" }, { status: 500 });
  }
}
