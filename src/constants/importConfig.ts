...
import { CONTENT_IMPORT_PLATFORMS } from "@/constants/contentImportPlatform";
...
const CONTENT_IMPORT_CONFIG: ImportConfig = {
    endpoint: "/api/content-import",
    platforms: CONTENT_IMPORT_PLATFORMS,
};
...
export const IMPORT_CONFIG_BY_PLATFORM: Record<Platform, ImportConfig> = {
    ...
    facebook_content: CONTENT_IMPORT_CONFIG,
};
